...
{{ $doctors->links() }}
     ...
     <form method="POST" enctype="multipart/form-data" action="{{route('doctorCreate')}}" >
                ...
                @csrf
                    ...
                    <div class="form-group">
                        ...
                        <input name="doctor_id" type="text" class="form-control" id="exampleInputName" placeholder="Enter Doctor ID">
                ...
                <div class="form-group">
                    ...
                    <input name="name" type="text" class="form-control" id="exampleInputName" placeholder="Enter Doctor Name">
                    ...
                    <div class="form-group">
                        ...
                        <input name="degree" type="text" class="form-control" id="exampleInputName" placeholder="Enter Qualification">
                ...
                <div class="form-group">
                    ...
                    <div class="form-group">
                        ...
                        <input name="chamber" type="text" class="form-control" id="exampleInputName" placeholder="Enter Chamber Name">
                    ...
                    <div class="form-group">
                        ...
                        <input name="PerDay_visit" type="text" class="form-control" id="exampleInputName" placeholder="Enter Per-day Number  ">
    ...
    <div class="form-group">
                    ...
                    <input name="email" type="email" class="form-control" id="exampleInputEmail1" placeholder="Enter Doctor Email Address">

                </div>
     <div class="form-group">

                    <input name="contact" type="number" class="form-control" id="exampleInputPhone" placeholder="Enter Doctor Phone Number">

                </div>
                <div class="form-group">

                    <input name="password" type="password" class="form-control" id="exampleInputPassword" placeholder="Enter Doctor Password">
